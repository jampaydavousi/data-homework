...
with open(output_file, "w") as data_file:
    text_writer = csv.writer(data_file)

 # write in the new header
    text_writer.writerow(["Candidate", "Percentage of Votes", "Number of Votes"])

    # write details
    text_writer.writerows(results)

    # write winner
    text_writer.writerow(str(winner_name))
